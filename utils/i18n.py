...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "unrealised":          {"en": "unrealised",           "th": "กำไร/ขาดทุนที่ยังไม่รับรู้"},
    ...
    "mkt_value":           {"en": "Mkt Value",            "th": "มูลค่าตลาด"},

    # ── Dividend calendar ────────────────────────────────────────────────────
    "smart_checklist":    {"en": "Dividend Calendar — Smart Checklist",
                           "th": "ตารางปันผล — รายการตรวจสอบอัจฉริยะ"},
    "confirmed":          {"en": "✅ Confirmed",          "th": "✅ ยืนยันแล้ว"},
    "process_confirmed":  {"en": "✅ Process Confirmed Dividends",
                           "th": "✅ ประมวลผลปันผลที่ยืนยัน"},
    ...
    # ── WHT reconciliation ───────────────────────────────────────────────────
    "wht_recon":          {"en": "Withholding Tax Reconciliation",
                           "th": "การตรวจสอบภาษีหัก ณ ที่จ่าย"},
    ...
    # ── Exit simulator ───────────────────────────────────────────────────────
    "exit_sim_title":     {"en": "🚪 Exit Position Simulator",
                           "th": "🚪 จำลองการขายหลักทรัพย์"},
    ...
    # ── AI Research ──────────────────────────────────────────────────────────
    "ai_research_title":  {"en": "🤖 AI Portfolio Research Agent",
                           "th": "🤖 ผู้ช่วย AI วิเคราะห์พอร์ต"},
    "ask_anything":       {"en": "Ask anything about your portfolio...",
                           "th": "ถามอะไรก็ได้เกี่ยวกับพอร์ตของคุณ..."},
    "language_toggle":    {"en": "🌐 ภาษาไทย",           "th": "🌐 English"},

    # ── KAsset / Finnomena ───────────────────────────────────────────────────
    "kasset_overview":    {"en": "KAsset Wisdom — K-FIXED-A",
                           "th": "กองทุน KAsset Wisdom — K-FIXED-A"},
    "nav_stale":          {"en": "⚠️ NAV data may be outdated",
                           "th": "⚠️ ข้อมูล NAV อาจไม่เป็นปัจจุบัน"},
...
def lang_toggle_button():
    ...
    try:
        ...
        if st.sidebar.button(label, key="lang_toggle", use_container_width=True):
            current = get_lang()
